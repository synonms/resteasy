...
public class RestEasyBearerTokenRelayHandler : DelegatingHandler
{
    private readonly ILogger<RestEasyBearerTokenRelayHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public RestEasyBearerTokenRelayHandler(ILogger<RestEasyBearerTokenRelayHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
        _logger = logger;
