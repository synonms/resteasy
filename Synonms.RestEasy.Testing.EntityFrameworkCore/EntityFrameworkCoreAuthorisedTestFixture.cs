...
public abstract class EntityFrameworkCoreAuthorisedTestFixture<TWebApplicationFactory, TEntryPoint, TAggregateRoot, TResource, TDbContext> 
    : AuthorisedTestFixture<TWebApplicationFactory, TEntryPoint, TAggregateRoot, TResource>
...
{
    protected EntityFrameworkCoreAuthorisedTestFixture(TWebApplicationFactory webApplicationFactory, string mediaType, JsonSerializerOptions? jsonSerialiserOptions, int pageLimit, string userId, string createPermission, string readPermission, string updatePermission, string deletePermission) 
        : base(webApplicationFactory, mediaType, jsonSerialiserOptions, pageLimit, userId, createPermission, readPermission, updatePermission, deletePermission)
    {
    }
