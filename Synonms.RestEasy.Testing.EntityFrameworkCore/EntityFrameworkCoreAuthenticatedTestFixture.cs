...
public abstract class EntityFrameworkCoreAuthenticatedTestFixture<TWebApplicationFactory, TEntryPoint, TAggregateRoot, TResource, TDbContext> 
    : AuthenticatedTestFixture<TWebApplicationFactory, TEntryPoint, TAggregateRoot, TResource>
...
{
    protected EntityFrameworkCoreAuthenticatedTestFixture(TWebApplicationFactory webApplicationFactory, string mediaType, JsonSerializerOptions? jsonSerialiserOptions, int pageLimit, string userId) 
        : base(webApplicationFactory, mediaType, jsonSerialiserOptions, pageLimit, userId)
    {
    }
