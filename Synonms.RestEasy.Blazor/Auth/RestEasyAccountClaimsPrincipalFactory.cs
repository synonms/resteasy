...
public class RestEasyAccountClaimsPrincipalFactory(IAccessTokenProviderAccessor accessor, IPermissionProvider permissionProvider) : AccountClaimsPrincipalFactory<RemoteUserAccount>(accessor)
{
